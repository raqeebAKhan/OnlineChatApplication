package com.chatapp.swiftchat.services
...
class SendMediaService : Service() {
    ...
    private fun createChannel() {
        ...
        channel.lightColor = R.color.purpleLight
    ...
    private fun compressImage(fileName: String): String? {
        val file =
            File(Environment.getExternalStorageDirectory().absoluteFile, "SwiftChat/Media/Sent/")
